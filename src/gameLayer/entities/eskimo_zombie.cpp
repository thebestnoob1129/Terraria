#include "eskimo_zombie.h"

#include <assetManager.h>
#include <helpers.h>

void EskimoZombie::render(AssetManager& assetManager)
{
	auto aabb = physics.transform.getAABB();

	DrawTexturePro(
		assetManager.eskimo_zombie,
...
bool EskimoZombie::update(float deltaTime, EntityUpdateData entityUpdateData)
{
	TickTint(deltaTime);
